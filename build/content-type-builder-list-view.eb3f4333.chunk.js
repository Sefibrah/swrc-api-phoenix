"use strict";(self.webpackChunkstrapi=self.webpackChunkstrapi||[]).push([[5905],{3500:(it,_,a)=>{a.r(_),a.d(_,{default:()=>lt});var e=a(67294),Ce=a(90731),b=a(96987),B=a(12473),Te=a(34726),y=a(16607),c=a(32638),F=a(83598),ve=a(18226),ee=a(2382),Ze=a(97695),xe=a(27361),Z=a.n(xe),$e=a(18721),Me=a.n($e),Re=a(18446),te=a.n(Re),ke=a(11700),ne=a.n(ke),A=a(86896),O=a(16550),oe=a(5923),ae=a(3547),le=a(29299),N=a(69398),h=a(71068),De=a(38454),Le=a(45697),n=a.n(Le),I=a(27523),re=a(47558),f=a(90635),E=a(71997);const ie=E.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`;function V({customRowComponent:t,component:o,isFromDynamicZone:l,isNestedInDZComponent:r,firstLoopComponentUid:d}){const{modifiedData:s}=(0,I.Z)(),{schema:{attributes:p}}=Z()(s,["components",o],{schema:{attributes:[]}});return e.createElement(ie,{isChildOfDynamicZone:l,className:"component-row"},e.createElement("td",{colSpan:12},e.createElement(pe,{customRowComponent:t,items:p,targetUid:o,firstLoopComponentUid:d||o,editTarget:"components",isFromDynamicZone:l,isNestedInDZComponent:r,isSub:!0,secondLoopComponentUid:d?o:null})))}V.defaultProps={component:null,customRowComponent:null,firstLoopComponentUid:null,isFromDynamicZone:!1,isNestedInDZComponent:!1},V.propTypes={component:n().string,customRowComponent:n().func,firstLoopComponentUid:n().string,isFromDynamicZone:n().bool,isNestedInDZComponent:n().bool};const se=V;var Pe=a(35771),Ae=a(85200),ce=a(25237);function j({isActive:t,icon:o}){return e.createElement(b.k,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%"},e.createElement(Ae.J,{as:ce.c[o]||ce.c.cube,height:5,width:5}))}j.defaultProps={isActive:!1,icon:"Cube"},j.propTypes={isActive:n().bool,icon:n().string};const de=(0,E.ZP)(y.x)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,c.pxToRem)(8)};
