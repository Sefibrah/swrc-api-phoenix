...
/**
 * recurring-discount router
 */

const sameUserGroupPolicyConfig = {
  name: "plugin::multi-tenant.is-same-user-group",
  config: {
    contentType: "api::recurring-discount.recurring-discount",
  },
};

const { createCoreRouter } = require('@strapi/strapi').factories;

module.exports = createCoreRouter('api::recurring-discount.recurring-discount', {
  config: {
    update: {
